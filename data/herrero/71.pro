...
/*    CON HOJA CENTRAL Y LATERAL EN LA MISMA GUIA */
   ...
   DESARMAR SOLO SI n_hojas=3 .AND. tipo_gui=1
      ...
      VIDRIOS
         ...
         DESARMAR SOLO SI tra1=0 .AND. tra2=0
            3 de m_ancho/3-80 x m_alto-107
         FIN DESARME

         /* tra1= posicion del travesanio */
         DESARMAR SOLO SI tra1>0
            3 de m_ancho/3-80 x tra1-66-16.5
            3 de m_ancho/3-80 x m_alto-tra1-41-16.5
         FIN DESARME

         /* tra2= cantidad de traviesas, se suponen centradas */
         DESARMAR SOLO SI tra2>0
            3*(tra2+1) de m_ancho/3-80 x (m_alto-107-33*tra2)/(tra2+1)
         FIN DESARME
...
/*    CON HOJAS LATERALES EN LA MISMA GUIA */
   ...
   DESARMAR SOLO SI n_hojas=3 .AND. tipo_gui=2
      ...
      VIDRIOS
         ...
         DESARMAR SOLO SI tra1=0 .AND. tra2=0
            3 de m_ancho/3-63 x m_alto-107
         FIN DESARME

         /* tra1= posicion del travesanio */
         DESARMAR SOLO SI tra1>0
            3 de m_ancho/3-63 x tra1-66-16.5
            3 de m_ancho/3-63 x m_alto-tra1-41-16.5
         FIN DESARME

         /* tra2= cantidad de traviesas, se suponen centradas */
         DESARMAR SOLO SI tra2>0
            3*(tra2+1) de m_ancho/3-63 x (m_alto-107-33*tra2)/(tra2+1)
         FIN DESARME
...
DESARMAR SOLO SI n_hojas=3
   ...
   DESARMAR SOLO SI n_hojas=4
      ...
      VIDRIOS
         ...
         DESARMAR SOLO SI tra1=0 .AND. tra2=0
            4 de m_ancho/4-71 x m_alto-107
         FIN DESARME

         /* tra1= posicion del travesanio */
         DESARMAR SOLO SI tra1>0
            4 de m_ancho/4-71 x tra1-66-16.5
            4 de m_ancho/4-71 x m_alto-tra1-41-16.5
         FIN DESARME

         /* tra2= cantidad de traviesas, se suponen centradas */
         DESARMAR SOLO SI tra2>0
            4*(tra2+1) de m_ancho/4-71 x (m_alto-107-33*tra2)/(tra2+1)
         FIN DESARME
