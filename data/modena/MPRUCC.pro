   ...
   DESARMAR SOLO SI n_hojas=1
      ...
      DESARMAR SOLO SI tra1=0
         ...
         PARTE T96
            ...
            4 x INT((m_alto-189-40)/300) + 2
         FIN DESARME
      /* NO lleva travesanio */
         VIDRIOS
            1 de m_ancho-205 x m_alto-205
     FIN DESARME
      ...
      DESARMAR SOLO SI tra1>0
         ...
         CORTES A 45:
            ...
            2*(tra1+1) x (m_alto-(tra1*60)-189)/(tra1+1)
            SEGUN contravid PERFIL C6212,C6225,C6230,C6231
            2*(tra1+1) x m_ancho-189-e_cont
            2*(tra1+1) x (m_alto-(tra1*60)-189)/(tra1+1)
         DESARMAR SOLO SI cv_ext=1
         PARTE T96
            ...
            4 x INT((m_alto-(tra1*60)-189)/300) + 2
         FIN DESARME
      /* LLEVA TRAVESANIOS centrados*/
         VIDRIOS
            tra1+1 de m_ancho-205 x (m_alto-(tra1*72)-205)/(tra1+1)
      FIN DESARME
   ...
   DESARMAR SOLO SI n_hojas=2
      ...
      DESARMAR SOLO SI tra1>0 
         ...
         CORTES A 45:
            ...
            4*(tra1+1) x (m_alto-(tra1*60)-189)/(tra1+1)
            SEGUN contravid PERFIL C6212,C6225,C6230,C6231
            4*(tra1+1) x m_ancho/2-175-e_cont
            4*(tra1+1) x (m_alto-(tra1*60)-189)/(tra1+1)
      ...
      DESARMAR SOLO SI tra1=0 
         VIDRIOS
            2 de m_ancho/2-189-2 x m_alto-205
      FIN DESARME

      /* LLEVA un TRAVESANIO */
      DESARMAR SOLO SI tra1>0 
         VIDRIOS
            2*(tra1+1) de m_ancho/2-189-2 x (m_alto-(tra1*72)-205)/(tra1+1)
      FIN DESARME
