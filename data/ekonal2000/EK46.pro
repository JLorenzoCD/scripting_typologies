   ...
   /* Ventanas de 2 Hojas */
   	DESARMAR SOLO SI n_hojas=2
        ...
        FIN DESARME
		   ...
		   DESARMAR SOLO SI corte=0 .AND. marco=2
         		2 x m_ancho/2-120
		   FIN DESARME
		   DESARMAR SOLO SI corte=0 .AND. marco=1
         		2 x m_ancho/2-100
		   FIN DESARME
      ...
      /* Guia Barrios y tapacintas */
		DESARMAR SOLO SI tipo_gui=3
			...
			PERFIL 715
         	...
         	DESARMAR SOLO SI tra1=0 .AND. tra2=0
            		2 de m_ancho/2-100+18 x m_alto-148-25
         	FIN DESARME

         /* tra1= posicion del travesanio */
         	DESARMAR SOLO SI tra1>0
            			2 de m_ancho/2-100+18 x tra1-33-41-16.5-25
         		PANELES
      ...
      /* Guia Barrios y tapacintas */
		DESARMAR SOLO SI tipo_gui=3
         ...
         VIDRIOS
         	...
         	DESARMAR SOLO SI tra1=0 .AND. tra2=0
            		3 de m_ancho/3-79 x m_alto-148-25
         	FIN DESARME

         	/* tra1= posicion del travesanio */
         	DESARMAR SOLO SI tra1>0
            		3 de m_ancho/3-79 x tra1-74-16.5-25
            	PANELES
         ...
         /* tra2= cantidad de traviesas, se suponen centradas */
         	DESARMAR SOLO SI tra2>0
            		3*(tra2+1) de m_ancho/3-79 x (m_alto-66-82-25-33*tra2)/(tra2+1)
         	FIN DESARME
