...
FIN CALCULOS
   ...
   DESARMAR SOLO SI vr_tra1=0 .AND. vr_par1!=0
      ...
      VIDRIOS
         SEPARACION
         vr_par1+1 de  (m_ancho-15-13*vr_par1)/(1+vr_par1) x m_alto-24
      FIN DESARME

   /* Travesanios y ningun parante*/
   DESARMAR SOLO SI vr_tra1!=0 .AND. vr_par1=0
      PERFIL 6571
         vr_tra1 x m_ancho-24
      VIDRIOS
         SEPARACION
         vr_tra1+1 de  m_ancho-24 x (m_alto-15-13*vr_tra1)/(1+vr_tra1)
   FIN DESARME
   ...
   DESARMAR SOLO SI vr_par1!=0 .AND. vr_tra1!=0
      PERFIL 6571
         vr_tra1 x m_ancho-24
         vr_par1*(vr_tra1+1) x (m_alto-20-vr_tra1*6)/(vr_tra1+1)
      VIDRIOS
         SEPARACION
            CALCULOS
               vid_h:=(m_ancho-24-13*vr_par1)/(1+vr_par1)-3
               vid_v:=(m_alto-24-13*vr_tra1)/(1+vr_tra1)+3
            FIN CALCULOS
