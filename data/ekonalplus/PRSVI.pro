...
DESARMAR SOLO SI n_hojas=1
      ...
      DESARMAR SOLO SI cristal=0
        /* tablilla de postigon */
                CORTES A RECTO:
                PERFIL 5800
                 n_hojas * INT((m_alto-110)/62)+1 x m_ancho-116
        FIN DESARME
      ...
      FIN DESARME
       ...
       DESARMAR SOLO SI cristal=1
        ...
        /* tablilla de postigon */
                CORTES A RECTO:
                PERFIL 5800
                 n_hojas * INT((m_alto-110)/62)+1 x m_ancho-90
         FIN DESARME
...
DESARMAR SOLO SI n_hojas=2
        ...
        /* TABLILLA POSTIGON */
                PERFIL 5800
                n_hojas*INT(m_alto/1000*14+0.5) x m_ancho/2-69
         FIN DESARME
         DESARMAR SOLO SI cristal=1
            VIDRIOS
...
DESARMAR SOLO SI n_hojas=3
        ...
        /* TABLILLA POSTIGON */
                PERFIL 5800
                n_hojas*INT(m_alto/1000*14+0.5) x m_ancho/3-100
         FIN DESARME
         DESARMAR SOLO SI cristal=1
             VIDRIOS
        ...
        /* TABLILLA POSTIGON */
                PERFIL 5800
                n_hojas*INT(m_alto/1000*14+0.5) x m_ancho/3-62
        FIN DESARME
        DESARMAR SOLO SI cristal=1
            VIDRIOS
...
DESARMAR SOLO SI n_hojas=4
        ...
        /* TABLILLA POSTIGON */
                PERFIL 5800
                n_hojas*INT(m_alto/1000*14+0.5) x m_ancho/4-96
        FIN DESARME
        DESARMAR SOLO SI cristal=1
            VIDRIOS
        ...
        /* ENCUENTRO CENTRAL*/
           ...
           /* TABLILLA POSTIGON */
                   PERFIL 5800
                   n_hojas*INT(m_alto/1000*14+0.5) x m_ancho/4-59
           FIN DESARME
           DESARMAR SOLO SI cristal=1
               VIDRIOS
                    4 de m_ancho/4-96 x m_alto-110
